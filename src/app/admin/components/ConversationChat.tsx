      ...
      <div className={`shrink-0 border-t ${isNote ? "border-yellow-200 bg-yellow-50" : "border-gray-200 bg-white"} px-3 py-2`}>
        <div className="flex items-end gap-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg bg-indigo-500 text-white text-sm font-medium hover:bg-indigo-600 disabled:opacity-40 disabled:cursor-not-allowed transition-colors shrink-0"
          >
            {sending ? "..." : "→"}
          </button>
        </div>
