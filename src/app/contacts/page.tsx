...
export const metadata: Metadata = {
  title: "Контакты",
  description:
    "Контакты gmshop 66: телефон, адрес и режим работы. Запчасти GM (Opel, Chevrolet), заказ и консультация.",
...
export default function ContactsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-slate-600">Свяжитесь с <span className="font-semibold text-amber-700">gmshop 66</span> — ответим и подберём запчасти.</p>
      ...
      <div className="rounded-xl border border-amber-100 bg-white p-4 shadow-sm sm:p-6">
        ...
        <div className="mt-4 overflow-hidden rounded-lg border border-slate-200 bg-slate-100">
          <iframe
            title="gmshop 66 на Яндекс.Картах"
