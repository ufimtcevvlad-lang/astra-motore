...
export const metadata: Metadata = {
  title: "Гарантия",
  description: "Положение о гарантии на запчасти GM Shop.",
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <SimpleDoc title="Положение о гарантии">
        ...
        <p>
          Настоящее Положение определяет условия гарантии на товары, приобретенные в интернет-магазине GM Shop,
