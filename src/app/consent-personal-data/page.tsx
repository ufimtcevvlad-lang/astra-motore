...
export const metadata: Metadata = {
  ...
  description: "Форма согласия на обработку персональных данных пользователей сайта GM Shop.",
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <SimpleDoc title="Согласие субъекта на обработку персональных данных">
        ...
        <p>
          Настоящим, оставляя данные на сайте GM Shop, я свободно, своей волей и в своем интересе даю согласие
