...
export const metadata: Metadata = {
  title: "Как заказать",
  description:
    "Как заказать запчасти в gmshop 66: выбор товара, оформление корзины, подтверждение менеджером. Оригинал и аналоги.",
...
export default function HowToOrderPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      />
      <h1 className="text-2xl font-bold text-amber-900">Как заказать в gmshop 66</h1>
