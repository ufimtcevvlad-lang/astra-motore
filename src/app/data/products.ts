...
const OPEL_PILOT_RAW: Array<{
  ...
  },
  {
    ...
    description:
      "Клапанная крышка в сборе / узел ГБЦ для Cruze с двигателями F16D4 и F18D4. Первый кадр — крупно этикетка с номером **96889998**; далее крышка сверху и снизу. Замена при трещинах, деформации или неконтролируемой течи масла сверху мотора — работы согласуйте с сервисом.",
  },
  {
    id: "opel-29",
