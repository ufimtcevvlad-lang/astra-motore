...
const OPEL_PILOT_RAW: Array<{
  ...
  },
  {
    ...
    images: [
      ...
      "/images/catalog/opel-35/03-box-label.png",
      "/images/catalog/opel-35/04-seal-face.png",
      "/images/catalog/opel-35/05-seal-angle.png",
    ],
    description:
      "Сальник коленвала передний Elring, в упаковке указаны тип **A/BS F RD VMQ** и размеры **35×48×7** мм (артикул в выгрузке — 056900). В галерее: коробка, сальник и дополнительные ракурсы. Меняется при замене сцепления/ДМРВ или при течи с передней стороны коленвала. Перед заказом сверяйте размеры и применение по VIN или каталогу.",
  },
  {
    id: "opel-36",
  ...
  },
  {
    ...
    images: ["/images/catalog/opel-42/01-box.png"],
    description:
  ...
  },
  {
    ...
    image: "/images/catalog/_pending.jpg",
    description:
      "Комплект шатунных вкладышей ремонтного размера **0,25** Kolbenschmidt, артикул **87409610**. Меняются при капремонте или задиров шатунных шеек; подбор размера и объёма комплекта — по каталогу и замерам. Перед заказом сверяйте применение по VIN.",
  },
  {
    id: "opel-102",
    ...
    image: "/images/catalog/_pending.jpg",
    description:
      "Поршневые кольца **KS** на **один цилиндр**, стандартный размер (**STD**), артикул **800038910000**. Для полного мотора заказывайте кратно числу цилиндров. Перед заказом сверяйте маркировку поршней и применение по VIN или каталогу.",
  },
  {
    id: "opel-103",
  ...
  },
  {
    ...
    image: "/images/catalog/_pending.jpg",
    description:
      "Прокладка / уплотнение линии маслонасоса GM **55562793** для двигателя **A14NET**. Меняется при снятии насоса или при подсосе масла в месте стыка — повторную установку старой прокладки не рекомендуем. Перед заказом сверяйте применение по VIN.",
  },
  {
    id: "opel-105",
