...
export function HomeHero() {
  return (
    <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#05070A] via-[#0f172a] to-[#020617] p-6 text-white shadow-2xl sm:p-10">
      ...
      <div className="relative z-10 grid items-center gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
        <div className="space-y-5">
          ...
          <p className="max-w-xl text-sm leading-relaxed text-slate-300 sm:text-base">
            12 лет специализируемся на запчастях GM в Екатеринбурге. Оригинал и проверенные
            европейские бренды — никакого безымянного хлама. Редкие позиции, которые не могут
            достать крупные поставщики.
          </p>
