    ...
    <footer className="mt-auto border-t-2 border-amber-500/40 bg-gradient-to-b from-neutral-950 via-slate-950 to-black text-slate-100">
      <div className="mx-auto max-w-7xl px-4 py-6">
        ...
        <div className="mt-6 text-xs leading-relaxed text-slate-400">
          <p>
            Индивидуальный предприниматель Невьянцев Антон Александрович, свидетельство № 608466621 от 08 июля 2021 года, ИНН 667472249310, ОГРНИП 321665800117840, адрес: Свердловская обл., г. Екатеринбург, ул. Крестинского, д. 27, кв. 269.
          </p>
        </div>
      </div>
    </footer>
