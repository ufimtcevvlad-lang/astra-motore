...
export const metadata: Metadata = {
  title: "О компании GM Shop",
  description:
    "GM Shop — магазин автозапчастей для Opel и Chevrolet в Екатеринбурге. Подбор по VIN, оригинальные детали и качественные аналоги, помощь с выбором и заказом.",
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <CatalogChrome
        ...
        title="О компании"
      />
      <SimpleDoc title="GM Shop">
        <p>
          <strong>GM Shop</strong> — специализированный магазин автозапчастей для автомобилей Opel и Chevrolet в
        ...
        <h2 className="text-lg font-semibold text-slate-900">Что вы получаете в GM Shop</h2>
