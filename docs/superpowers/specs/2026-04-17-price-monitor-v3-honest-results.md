...
| Статус | Значение |
|---|---|
| `OFFERS` | Нашли один или несколько офферов в наличии. Возвращаем список. |
  ...
  "sites": [
    {
      ...
      "status": "OFFERS",
      "offers": [
        {"price": 311, "delivery_days": 2, "in_stock": true, "seller_name": "Уфа-Склад"}
      ],
      "found_brands": null,
      "error_category": null,
      "error_text": null,
...
│                                                                  │
│ Мин: 309₽  Медиана: 395₽  Макс: 509₽  (3 из 6 сайтов ответили) │
│                                                                  │
│ ┌──────────────┬──────────┬────────┬──────────┬──────────────┐ │
│ │ Сайт         │ Статус   │ Цена   │ Доставка │ Наличие      │ │
│ ├──────────────┼──────────┼────────┼──────────┼──────────────┤ │
│ │ exist.ru     │ 🟢 Офферы│ 311₽   │ 2 дн.    │ ✓ Уфа-Склад  │ │
│ │              │          │ 332₽   │ 5 дн.    │ ✓ ТрансАвто  │ │
│ │ emex.ru      │ 🔴 Ошибка│ —      │ —        │ timeout 30s  │ │
│ │ armtek.ru    │ ⚪ Нет кр.│ —      │ —        │ нет ARMTEK_..│ │
│ │ part-kom.ru  │ 🟠 Не нашёл│ —    │ —        │ сайт знает:  │ │
│ │              │          │        │          │ Robert Bosch,│ │
│ │              │          │        │          │ Бош, BOSCH   │ │
│ │              │          │        │          │ [+ алиас]    │ │
│ │ vdopel.ru    │ 🟡 Нет в нал│ —   │ —        │ 0 шт         │ │
│ │ plentycar.ru │ 🟢 Офферы│ 410₽   │ 3 дн.    │ ✓            │ │
│ └──────────────┴──────────┴────────┴──────────┴──────────────┘ │
└─────────────────────────────────────────────────────────────────┘
```
