...
- **Порядок кадров (обязательно):** **1)** целая коробка / заводская упаковка (полный кадр, не только вырезка с номером); **2)** крупный план этикетки с **артикулом**, читаемым на фото; **3+)** сама деталь (виды сверху/снизу/сбоку и т.д.). Если коробки пока нет — первым ставьте лучший полный вид детали, этикетку — вторым, и зафиксируйте в `description`, что фото коробки добавите позже.
